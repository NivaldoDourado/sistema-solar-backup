...
export const CORRESPONDENCIAS_APROVADAS: Record<string, number> = {
  ...
  "DRAGA D´ÁGUA A DIESE": 120006,  // DRAGA D'AGUA A DIESEL (variante truncada na planilha)
  "DRAGA D'ÁGUA A DIESEL": 120006, // DRAGA D'AGUA A DIESEL (variante)
  "DRAGA D'ÁGUA A DIESE": 120006,  // DRAGA D'AGUA A DIESEL (variante truncada)
  ...
  // Adicionados em Junho/2026:
  "OEQ 6268": 570002,              // LANCER OEQ 6268 (Setor: OFICINA)
  "QMK7C36": 570003,              // NISSA / KICKS SV CVT (Setor: ADMINISTRAÇÃO)
  "TNU2H07": 570004,              // VOLKSWAGEN TCROSS (Setor: ADMINISTRAÇÃO)
  "TRATOR D4E": 570005,           // TRATOR ESTEIRA D-4E (Setor: OUTROS SERVIÇOS)
  "TRATOR D4E — TRATOR ESTEIRA D - 4E": 570005, // variante com descrição
};
...
export const TAGS_OUTRAS_DESP_SETOR: Record<string, string> = {
  ...
  "ALMOXARIFADOOFICINA": "ALMOXARIFADO",
  "ALMOXARIFADO OFICINA": "ALMOXARIFADO",
  "CANTINA": "REFEITÓRIO",
...
export const TAGS_EXCLUIR: string[] = [
  ...
  // Excluídos a partir de Junho/2026 (outro negócio):
  "HMQ6155", "QKV 4F39 MB", "QMD 0H48", "QMD0H48",
  "RKM 1C68", "TC01 (OM100 RM)", "TC02 (OM100 / RM)", "TC02 (OM100/RM)",
  "TC03 (OM100 / RM)", "TC03 (OM100/RM)", "TC04 (H3800 01 RM)",
];
